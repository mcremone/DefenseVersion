...
In the last 20 years several experiments were aimed at studying CMB properties, confirming with impressive precision that the CMB has a black body spectrum. Its temperature today is well measured to be $T_0=2.7255 \pm 0.0006$ K (\citealt{Fixsen}). Moreover in 1992 the COBE satellite revealed that the CMB presents small temperature anisotropies at a level of $\Delta T /T \sim 10^{-ˆ’5}$. These anisotropies are the product of physical processes that mainly happened before decoupling and are originated by the same initial conditions that seeded the inhomogeneities that we observe today in the matter distribution.
...
\begin{figure}\centering
\includegraphics[width=0.5\textwidth]{/Users/apalmese/work/PhD_thesis/thesis_format/chapters/chapter1/figs/GW170817_1d.pdf}\includegraphics[width=0.5\textwidth]{/Users/apalmese/work/PhD_thesis/thesis_format/chapters/chapter1/figs/GW170817_14d.pdf}
